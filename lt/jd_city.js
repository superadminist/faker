...
const author_codes = ['57yoH81ZGTUkBHeNM6iJu4xJdzsE2g'].sort(() => 0.5 - Math.random())
const self_code = ['57yoH81ZGTUkBHeNM6iJu4xJdzsE2g']
let pool = ['57yoH81ZGTUkBHeNM6iJu4xJdzsE2g']
!(async () => {
...
function shareCodesFormat() {
  return new Promise(async resolve => {
    ...
    //   $.newShareCodes = [...new Set([...author_codes,...pool,...$.newShareCodes])]
    // }
    $.newShareCodes=['57yoH81ZGTUkBHeNM6iJu4xJdzsE2g','222']
