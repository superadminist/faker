...
const author_codes = ['-ryULf5oEQ4VFXKeDqCSu3q3twTDBVI','57yoH81ZGTUkBHeNM6iJu4xJdzsE2g','oe39W6wKb2ZLYxqrCpeJ9wukM8_w'].sort(() => 0.5 - Math.random())
const self_code = ['-ryULf5oEQ4VFXKeDqCSu3q3twTDBVI','57yoH81ZGTUkBHeNM6iJu4xJdzsE2g','oe39W6wKb2ZLYxqrCpeJ9wukM8_w']
let pool = ['-ryULf5oEQ4VFXKeDqCSu3q3twTDBVI','57yoH81ZGTUkBHeNM6iJu4xJdzsE2g','oe39W6wKb2ZLYxqrCpeJ9wukM8_w']
!(async () => {
...
function readShareCode(num=3) {
  return new Promise(async resolve => {
    $.get({url: `https://api.jdsharecode.xyz/api/c1qity/${num}`, 'timeout': 1}, (err, resp, data) => {
      try {
        if (err) {
          console.log(`${JSON.stringify(err)}`)
          console.log(`${$.name} API请求失败，请检查网路重试`)
...
function shareCodesFormat() {
  return new Promise(async resolve => {
    ...
    $.newShareCodes = ['-ryULf5oEQ4VFXKeDqCSu3q3twTDBVI','57yoH81ZGTUkBHeNM6iJu4xJdzsE2g','oe39W6wKb2ZLYxqrCpeJ9wukM8_w']
